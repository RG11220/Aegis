// PKCS1v15 sign/verify; canonical: senderId:chatId:iv:ct
...
// EMSA-PKCS1-v1_5: 0x00 || 0x01 || PS || 0x00 || DigestInfo
...
export function rsaSign(privateKeyPem: string, canonical: string): string {
  ...
  const s = modPow(m, d, n); // s = m^d mod n
...
export function rsaVerify(
  ...
  try {
    ...
    const m    = modPow(s, e, n); // m = s^e mod n
