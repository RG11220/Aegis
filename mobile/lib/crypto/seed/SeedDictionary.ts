...
// Mobile port: removed "import { webcrypto } from 'crypto'" — uses globalThis.crypto directly.
 ...
 * Uses globalThis.crypto.getRandomValues (available in both Node 18+ and Hermes).
 */
