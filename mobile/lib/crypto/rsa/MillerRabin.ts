// Miller-Rabin primality: deterministic prefilter + 40 probabilistic rounds

import { modPow, bytesToBigInt } from "./RsaMath";
import type { SeededRng }        from "../seed/SeededRng";

// 12 witnesses, no false positives for n < 2^82
...
// 40 random-witness rounds, error < 2^{-80}
